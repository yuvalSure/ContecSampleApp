    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                ...
                if ((!TextUtils.isEmpty(deviceName)) /*&& (device.getName().contains("ECGWS")||device.getName().contains("8000GW")||device.getName().contains("CB100"))*/) {
                    mNewDevicesArrayAdapter.remove(deviceName + "\n" + deviceAddress);
